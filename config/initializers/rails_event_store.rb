...
Rails.configuration.to_prepare do
  ...
  Rails.configuration.event_store.subscribe(LinkEventToStreamCommand.new('lemlist'), to: [
    LinkedinInviteAcceptedEvent,
    LinkedinInviteSentEvent,
    AddLeadToLemlistCampaignCommand])
